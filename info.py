...
# Bot information
SESSION = environ.get('SESSION', 'FILTER-BOT')
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002092771823') # give your force subscribe channel id here else leave it blank
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://fladofficial777:n1d643xtGzpy5Lq8@cluster0.6x1lp.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'fladofficial777')
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "only-rakel-yaswanth144-7ccc225d.koyeb.app/")
