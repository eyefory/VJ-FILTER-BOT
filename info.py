...
API_ID = int(environ.get('API_ID', '27671846'))
API_HASH = environ.get('API_HASH', 'cc06a836b64fe700de8a1a318186ad0a')
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5628652923').split()] # For Multiple Id Use One Space Between Each.
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '5628652923').split()]  # For Multiple Id Use One Space Between Each.
AUTH_USERS = (auth_users + ADMINS) if auth_users else []

# This Channel Is For When User Start Your Bot Then Bot Send That User Name And Id In This Log Channel, Same For Group Also.
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002472311803'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002472311803').split()]  # For Multiple Id Use One Space Between Each.
...
DATABASE_NAME = environ.get('DATABASE_NAME', "kcharantej7793")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'kcharantej7793')
